...
$this->params['breadcrumbs'][] = ['label' => 'Box Horarios', 'url' => ['boxs']];
...
echo Alert::widget([
	...
	'body' => 'El bloque agregado choca con uno existente',
]);
...
<?php
		...
		'options' => [
			...
			'header'=>'<h2><center>Crear Bloque de atención</center></h2>',
			//'id'=>'modal',
			'size'=>'modal-lg',
    ...
    $events = array();
	$test = new Event;
	$eventos = Event::find()->where(['id_box' => $_GET['id']])->all();
